#!/usr/bin/env python3
"""Useful constants and definitions for Empower LTE scheduled Message"""
...
class _ScheduleType(ct.c_uint16):
    pass

class _ScheduleHeader(ct.Structure):
    _pack_ = 1
    _fields_ = [('type', _ScheduleType),
                ('op', ct.c_uint8),
                ('interval', ct.c_uint32)
               ]
