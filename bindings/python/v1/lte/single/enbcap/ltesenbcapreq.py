...
class LTESEnbCapReq(LTESEnbCap):
    """Class that deals with a single EnBcap request"""
    ...
    def format(self, buf, size):
        ...
        repformat = self.proto.epf_single_ecap_req
    ...
    def parse(self, buf, size):
        ...
        repparse = self.proto.epp_single_ecap_req
